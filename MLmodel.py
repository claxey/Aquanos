...
def create_synthetic_data():
    ...
    # Define ranges for coordinates covering the coast of India and nearby ocean
    latitude_min = 5.0  # Lower boundary to include the southern tip of India
    latitude_max = 37.0  # Upper boundary to cover the northern part of India
    longitude_min = 68.0  # Western boundary to include parts of the Arabian Sea
    longitude_max = 92.0  # Eastern boundary to include parts of the Bay of Bengal and ocean
    ...
    'Current_Speed': np.round(np.random.uniform(low=0, high=2, size=num_samples), 3)  # Current speed in m/s
}
    ...
    def remove_outliers(df, column_name):
        ...
        # Define a threshold for Z-score to consider as outliers
        threshold = 3
        # Filter out outliers
        return df[np.abs(z_scores) < threshold]
    
    # Remove outliers from each relevant column
...
# Plot predicted vs actual fish populations
